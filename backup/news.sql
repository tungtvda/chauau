...
<div>
	如公知的，的辣椒高达30,000至50,000 Scolville热水平的类型，即使它是比著名jalape&ntilde;o辣椒更高4-20倍。如上所述，这种热度甚至可以&ldquo;穿刺&rdquo;你的舌头。</div>
',title='Admire the world\'s most expensive type of chili with a cost of half a ',title_cn='欣赏世界上最昂贵的类型辣椒有五十万公斤的成本',keyword='Admire the world\'s most expensive type of chili with a cost of half a billion kilograms',keyword_cn='Admire the world\'s most expensive type of chili with a cost of half a billion kilograms',description='Admire the world\'s most expensive type of chili with a cost of half a billion kilograms',description_cn='Admire the world\'s most expensive type of chili with a cost of half a billion kilograms',created='16-10-07 03:26:33' where id=5;
update news set danhmuc_id='1',name='Vietnamese dishes wanted to hear the name ',name_cn='越南菜想听到名字“shrink chopsticks”',name_url='vietnamese-dishes-wanted-to-hear-the-name-',img='/mix/view/admin/Themes/kcfinder/upload/images/new/dulich.jpg',content='<p style=\"margin: 12.5469px 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; color: rgb(0, 0, 0); font-stretch: normal; line-height: 20px; font-family: Arial; background-color: rgb(242, 242, 242);\">
	<strong style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\">1. Thịt chuột</strong></p>
<p style=\"margin: 12.5469px 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; color: rgb(0, 0, 0); font-stretch: normal; line-height: 20px; font-family: Arial; background-color: rgb(242, 242, 242);\">
	Nhiều nơi thuộc đồng bằng Bắc Bộ v&agrave; s&ocirc;ng Cửu Long, chuột được giao b&aacute;n rộng r&atilde;i như một nhu yếu phẩm cần thiết cho bữa ăn h&agrave;ng ng&agrave;y. Thậm ch&iacute;, tại nhiều miền qu&ecirc;, thịt chuột c&ograve;n được coi l&agrave; m&oacute;n đặc sản kh&ocirc;ng thể thiếu trong những dịp lễ tết trọng đại. Kh&ocirc;ng chỉ vậy, người Việt chế biến chuột c&ograve;n rất cầu k&igrave; v&agrave;...s&aacute;ng tạo với tr&ecirc;n 30 m&oacute;n ăn.</p>
...
<div>
	据西部人的观念，蝙蝠肉能治多种疾病，如咳嗽，肺结核。</div>
',title='Vietnamese dishes wanted to hear the name ',title_cn='越南菜想听到名字“shrink chopsticks”',keyword='Vietnamese dishes wanted to hear the name ',keyword_cn='Vietnamese dishes wanted to hear the name ',description='Vietnamese dishes wanted to hear the name ',description_cn='Vietnamese dishes wanted to hear the name ',created='16-10-07 03:26:37' where id=4;
update news set danhmuc_id='1',name='Filled with emotion with ',name_cn='感慨万千与“黄金季节”穆沧柴',name_url='filled-with-emotion-with-',img='/mix/view/admin/Themes/kcfinder/upload/images/new/dulich.jpg',content='<p style=\"margin: 12.5469px 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; color: rgb(0, 0, 0); font-stretch: normal; line-height: 20px; font-family: Arial; background-color: rgb(242, 242, 242);\">
	<i style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\">T&ocirc;i chỉ c&oacute; ng&agrave;y h&ocirc;m nay</i></p>
<p style=\"margin: 12.5469px 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; color: rgb(0, 0, 0); font-stretch: normal; line-height: 20px; font-family: Arial; background-color: rgb(242, 242, 242);\">
	<i style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\">Để cười v&agrave; để vui sống</i></p>
...
<div>
	感慨万千，以穆沧柴。</div>
',title='Filled with emotion with ',title_cn='感慨万千与“黄金季节”穆沧柴',keyword='Filled with emotion with ',keyword_cn='Filled with emotion with ',description='Filled with emotion with ',description_cn='Filled with emotion with ',created='16-10-07 03:26:39' where id=3;
update news set danhmuc_id='1',name='China built huge train station and the deepest under the Great Wall',name_cn='中国庞大的建火车站和最深下的长城',name_url='china-built-huge-train-station-and-the-deepest-under-the-great-wall',img='/mix/view/admin/Themes/kcfinder/upload/images/new/dulich.jpg',content='<p style=\"margin: 12.5469px 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; color: rgb(0, 0, 0); font-stretch: normal; line-height: 20px; font-family: Arial; background-color: rgb(242, 242, 242);\">
	Trong thời gian tới, Vạn L&yacute; Trường Th&agrave;nh sẽ c&oacute; nh&agrave; ga đường sắt tốc độ cao với kỷ lục về độ s&acirc;u v&agrave; lớn nhất thế giới. C&ocirc;ng tr&igrave;nh đầy tham vọng n&agrave;y l&agrave; một phần của 174 km đường sắt cao tốc, kết nối Bắc Kinh với Trương Gia Khẩu trong thời gian diễn ra Thế vận hội Olympic m&ugrave;a đ&ocirc;ng năm 2022 sắp tới. Theo đ&oacute;, h&agrave;nh kh&aacute;ch c&oacute; thể dừng ch&acirc;n tại B&aacute;t Đạt Lĩnh &ndash; đoạn thuộc Vạn L&yacute; Trường Th&agrave;nh c&aacute;ch Bắc Kinh chừng 80 km.</p>
<div class=\"VCSortableInPreviewMode\" style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; text-align: center; color: rgb(0, 0, 0); font-family: Arial; background-color: rgb(242, 242, 242);\" type=\"Photo\">
	<div style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\">
...
<div>
	据了解，八达岭站位于崎岖的山脉中，也成为古代世界最伟大的奇迹的一部分项目的最大挑战。然而，根据Duhao罗，负责这项工作的总工程师的份额，参与设计的工程师将使用最先进的技术，以不影响长城。</div>
',title='China built huge train station and the deepest under the Great Wall',title_cn='中国庞大的建火车站和最深下的长城',keyword='China built huge train station and the deepest under the Great Wall',keyword_cn='China built huge train station and the deepest under the Great Wall',description='China built huge train station and the deepest under the Great Wall',description_cn='China built huge train station and the deepest under the Great Wall',created='16-10-07 03:26:42' where id=2;
update news set danhmuc_id='1',name='4 field ravishingly beautiful shepherd in Vietnam',name_cn='在越南Ravishingly美丽的牧羊4场',name_url='4-field-ravishingly-beautiful-shepherd-in-vietnam',img='/mix/view/admin/Themes/kcfinder/upload/images/new/dulich.jpg',content='<p style=\"margin: 12.5469px 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; color: rgb(0, 0, 0); font-stretch: normal; line-height: 20px; font-family: Arial; background-color: rgb(242, 242, 242);\">
	<strong style=\"margin: 0px; padding: 0px; list-style: none; border: 0px; outline: none;\">1. Đồng cừu An H&ograve;a, Ninh Thuận</strong></p>
<p style=\"margin: 12.5469px 0px; padding: 0px; list-style: none; border: 0px; font-size: 13px; outline: none; color: rgb(0, 0, 0); font-stretch: normal; line-height: 20px; font-family: Arial; background-color: rgb(242, 242, 242);\">
	Nằm c&aacute;ch trung t&acirc;m th&agrave;nh phố Phan Rang khoảng 16 km theo hướng T&acirc;y Bắc chạy theo quốc lộ 1A, đồng cừu An H&ograve;a (th&ocirc;n An H&ograve;a, x&atilde; Xu&acirc;n Hải, huyện Ninh Hải) l&agrave; địa điểm l&iacute; tưởng được nhiều du kh&aacute;ch gh&eacute; thăm.</p>
...
update news set view='1' where id=4;
update news set view='2' where id=4;
update news set view='3' where id=4;
update news set view='4' where id=4;
update news set view='5' where id=4;
update news set view='6' where id=4;
update news set view='7' where id=4;
update news set view='8' where id=4;
update news set view='9' where id=4;
update news set view='10' where id=4;
update news set view='11' where id=4;
update news set view='12' where id=4;
update news set view='13' where id=4;
update news set view='14' where id=4;
