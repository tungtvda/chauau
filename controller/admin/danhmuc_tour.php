...
if(isset($_SESSION["Admin"]))
{
    ...
    if(isset($_POST["name"])&&isset($_POST["name_symbol"])&&isset($_POST["name_url"])&&isset($_POST["img"])&&isset($_POST["icon"])&&isset($_POST["position"])&&isset($_POST["content_short"])&&isset($_POST["title"])&&isset($_POST["keyword"])&&isset($_POST["description"]))
    {
       $array=$_POST;
       if(!isset($array['id']))
       $array['id']='0';
