                ...
                <div id="text-2" class="widget widget_text"><h3 class="widget-title">ABOUT TRAVELKIT</h3>
                    <div class="textwidget">
                        <div class="contact-info">
                            <p>Derby la isla bonita id elit. Duis <br>sed odio sit amet nibh.</p>
                            <div class="contact-info-share">
                                <p><i class="fa fa-map-marker"></i> 22 Seven Worcester</p>
                                <p><i class="fa fa-phone"></i> +098 8732 873212</p>
                                <p><i class="fa fa-envelope"></i>support@themeum.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <ul id="menu-booking" class="menu">
                            <li id="menu-item-1177"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1177"><a
                                    href="#">Top secret Hotels</a></li>
                            <li id="menu-item-1178"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1178"><a
                                    href="#">Afternoon Tea</a></li>
                            <li id="menu-item-1179"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1179"><a
                                    href="#">Weekend Breaks</a></li>
                            <li id="menu-item-1180"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1180"><a
                                    href="#">Sky Restaurant</a></li>
                            <li id="menu-item-1181"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1181"><a
                                    href="#">Garden Restaurant</a></li>
...
<footer id="footer" class="footer-wrap">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                © 2016 Your Company. &nbsp;Designed By <a href="http://themeum.com/" target="_blank"
                                                          class="copyright"> THEMEUM</a></div> <!-- end row -->
...
<script type='text/javascript'>
    /* <![CDATA[ */
    var _wpcf7 = {
        "loaderUrl": "http:\/\/demo.themeum.com\/wordpress\/wptravelkit\/demo2\/wp-content\/plugins\/contact-form-7\/images\/ajax-loader.gif",
...
<script type='text/javascript'>
    ...
    var _wpPluploadSettings = {
        "defaults": {
            ...
            "url": "\/wordpress\/wptravelkit\/demo2\/wp-admin\/async-upload.php",
            "flash_swf_url": "http:\/\/demo.themeum.com\/wordpress\/wptravelkit\/demo2\/wp-includes\/js\/plupload\/plupload.flash.swf",
            "silverlight_xap_url": "http:\/\/demo.themeum.com\/wordpress\/wptravelkit\/demo2\/wp-includes\/js\/plupload\/plupload.silverlight.xap",
            "filters": {
                "max_file_size": "2097152b",
                "mime_types": [{"extensions": "jpg,jpeg,jpe,png,gif,mov,qt,avi,mpeg,mpg,mpe,3gp,3gpp,3g2,3gp2,mid,midi,pdf,doc,docx,docm,pot,pps,ppt,pptx,pptm,odt,ppsx,ppsm,xla,xls,xlt,xlw,xlsx,xlsm,xlsb,key,mp3,m4a,m4b,ogg,oga,wma,wav,mp4,m4v,webm,ogv,wmv,flv"}]
            },
            "multipart_params": {"action": "upload-attachment", "_wpnonce": "8a6d9229d5"}
...
<script type='text/javascript'>
    ...
    var _wpmejsSettings = {"pluginPath": "\/wordpress\/wptravelkit\/demo2\/wp-includes\/js\/mediaelement\/"};
    /* ]]> */
</script>
...
<script type='text/javascript'>
    ...
    var _wpMediaViewsL10n = {
        ...
        "settings": {
            "tabs": [],
            "tabUrl": "http:\/\/demo.themeum.com\/wordpress\/wptravelkit\/demo2\/wp-admin\/media-upload.php?chromeless=1",
            "mimeTypes": {"image": "Images", "audio": "Audio", "video": "Video"},
            "captions": true,
            "nonce": {"sendToEditor": "8b28ee889b"},
            "post": {"id": 0},
            "defaultProps": {"link": "none", "align": "", "size": ""},
            "attachmentCounts": {"audio": 0, "video": 0},
            ...
            "contentWidth": null,
            "months": [{"year": "2016", "month": "11", "text": "November 2016"}, {
                "year": "2016",
                "month": "10",
                "text": "October 2016"
            }, {"year": "2016", "month": "9", "text": "September 2016"}, {
                "year": "2016",
                "month": "8",
                "text": "August 2016"
            }, {"year": "2016", "month": "7", "text": "July 2016"}],
            "mediaTrash": 0
        }
    };
    /* ]]> */
...
<script type='text/javascript' src='wp-content/themes/travelkit/js/bootstrap.min1c9b.js?ver=4.6.1'></script>
<script type='text/javascript' src='wp-content/themes/travelkit/js/loopcounter1c9b.js?ver=4.6.1'></script>
<script type='text/javascript' src='wp-content/themes/travelkit/js/jquery.prettySocial.min1c9b.js?ver=4.6.1'></script>
<script type='text/javascript' src='wp-content/themes/travelkit/js/ajax-booking-btn1c9b.js?ver=4.6.1'></script>
<script type='text/javascript' src='wp-includes/js/comment-reply.min1c9b.js?ver=4.6.1'></script>
<script type='text/javascript' src='wp-content/themes/travelkit/js/main1c9b.js?ver=4.6.1'></script>
<script type='text/javascript' src='wp-includes/js/wp-embed.min1c9b.js?ver=4.6.1'></script>
<script type='text/javascript'
        src='wp-content/plugins/js_composer/assets/js/dist/js_composer_front.mina752.js?ver=4.11.2.1'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
...
<script type='text/javascript'
        src='wp-content/plugins/mailchimp-for-wp/assets/js/forms-api.min1678.js?ver=4.0.7'></script>
<!--[if lte IE 9]>
<script type='text/javascript'
...
Object Caching 4730/5285 objects using disk
Page Caching using disk: enhanced

 Served from: demo.themeum.com @ 2016-11-26 07:38:21 by W3 Total Cache -->