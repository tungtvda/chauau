                    ...
                    <div id="rev_slider_2_1" class="rev_slider fullwidthabanner"
                        ...
                        <ul>    <!-- SLIDE  -->
                            <li data-index="rs-4" data-transition="fade"
                                ...
                                data-thumb="http://demo.themeum.com/wordpress/wptravelkit/demo2/wp-content/uploads/sites/2/2016/10/demo2-slider1-100x50.jpg"
                                ...
                                <!-- MAIN IMAGE -->
                                <img src="wp-content/uploads/sites/2/2016/10/demo2-slider1.jpg"
                                     alt="" title="demo2-slider1" width="1600" height="882"
                                ...
                                <div class="tp-caption   tp-resizeme"
                                     ...
                                     data-transform_out="x:50px;opacity:0;s:500;e:Power4.easeInOut;"
                                     data-start="500"
                                     data-splitin="none"
                                     data-splitout="none"
                                     ...
                                     style="z-index: 5; white-space: nowrap; font-size: 24px; line-height: 26px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Montserrat;">
                                    Greece Satorioni
                                </div>
                                ...
                                <h2 class="tp-caption   tp-resizeme"
                                    id="slide-4-layer-2"
                                    data-x="['center','center','center','center']"
                                    data-hoffset="['0','2','0','0']"
                                    data-y="['top','top','top','middle']"
                                    data-voffset="['280','220','155','-3']"
                                    data-fontsize="['72','48','48','25']"
                                    data-lineheight="['52','32','32','32']"
                                    ...
                                    data-transform_in="x:-50px;opacity:0;s:300;e:Power3.easeOut;"
                                    ...
                                    style="z-index: 6; white-space: nowrap; font-size: 72px; line-height: 52px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Montserrat;">
                                    START FROM $299 </h2>
                                ...
                                <div class="tp-caption   tp-resizeme"
                                     id="slide-4-layer-14"
                                     data-x="['center','center','center','center']"
                                     data-hoffset="['-1','0','5','0']"
                                     data-y="['middle','middle','top','top']"
                                     data-voffset="['84','73','200','208']"
                                     ...
                                     style="z-index: 7; white-space: nowrap; font-size: 16px; line-height: 22px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Montserrat;">
                                    <a class="btn  btn-transparent  btn-slider" href="#">Start
                                        Tour</a></div>
                                ...
                                <div class="tp-caption   tp-resizeme"
                                     ...
                                     style="z-index: 8; white-space: nowrap; font-size: 18px; line-height: 22px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Montserrat;text-align:center;">
                            ...
                            <li data-index="rs-8" data-transition="fade"
                                ...
                                data-hideslideonmobile="off" data-easein="default"
                                data-easeout="default" data-masterspeed="300"
                                data-thumb="http://demo.themeum.com/wordpress/wptravelkit/demo2/wp-content/uploads/sites/2/2016/11/slider4bg-100x50.jpg"
                                data-rotate="0" data-saveperformance="off" data-title="Slide"
                                data-param1="" data-param2="" data-param3="" data-param4=""
                                data-param5="" data-param6="" data-param7="" data-param8=""
                                data-param9="" data-param10="" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="wp-content/uploads/sites/2/2016/11/slider4bg.jpg"
                                     alt="" title="slider4bg" width="1920" height="1080"
                                     data-bgposition="center center" data-bgfit="cover"
                                     data-bgrepeat="no-repeat" class="rev-slidebg"
                                     data-no-retina>
                                <!-- LAYERS -->
                            ...
                            <li data-index="rs-7" data-transition="fade"
                                ...
                                data-hideslideonmobile="off" data-easein="default"
                                data-easeout="default" data-masterspeed="300"
                                data-thumb="http://demo.themeum.com/wordpress/wptravelkit/demo2/wp-content/uploads/sites/2/2016/11/slider5bg-100x50.jpg"
                                data-rotate="0" data-saveperformance="off" data-title="Slide"
                                data-param1="" data-param2="" data-param3="" data-param4=""
                                data-param5="" data-param6="" data-param7="" data-param8=""
                                data-param9="" data-param10="" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="wp-content/uploads/sites/2/2016/11/slider5bg.jpg"
                                     alt="" title="slider5bg" width="1920" height="1080"
                                     data-bgposition="center center" data-bgfit="cover"
                                     data-bgrepeat="no-repeat" class="rev-slidebg"
                                     data-no-retina>
                                <!-- LAYERS -->
                        ...
                        tpj(document).ready(function () {
                            if (tpj("#rev_slider_2_1").revolution == undefined) {
                                ...
                                revapi2 = tpj("#rev_slider_2_1").show().revolution({
                                    sliderType: "standard",
                                    jsFileLocation: "//demo.themeum.com/wordpress/wptravelkit/demo2/wp-content/plugins/revslider/public/assets/js/",
