...
{
   return hanhtrinh_color_Get("SELECT hanhtrinh_color.id, hanhtrinh.name as hanhtrinh_id, hanhtrinh_color.name, hanhtrinh_color.name_tab, hanhtrinh_color.color, hanhtrinh_color.content, hanhtrinh_color.positon FROM  hanhtrinh_color, hanhtrinh where hanhtrinh.id=hanhtrinh_color.hanhtrinh_id  ".(($where!='')?(' and '.$where):'')." Order By ".$Order." Limit ".(($CurrentPage-1)*$PageSize)." , ".$PageSize);
}
//
function hanhtrinh_color_insert($obj)
{
    return exe_query("insert into hanhtrinh_color (hanhtrinh_id,name, name_tab,color,content,positon) values ('$obj->hanhtrinh_id','$obj->name','$obj->name_tab','$obj->color','$obj->content','$obj->positon')",'hanhtrinh_color');
}
//
function hanhtrinh_color_update($obj)
{
    return exe_query("update hanhtrinh_color set hanhtrinh_id='$obj->hanhtrinh_id',name='$obj->name',name_tab='$obj->name_tab',color='$obj->color',content='$obj->content',positon='$obj->positon' where id=$obj->id",'hanhtrinh_color');
}
//
