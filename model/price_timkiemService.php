...
{
    return exe_query("insert into price_timkiem (id,name,value,position) values ('$obj->id','$obj->name','$obj->value','$obj->position')",'price_timkiem');
}
//
function price_timkiem_update($obj)
{
    return exe_query("update price_timkiem set id='$obj->id',name='$obj->name',value='$obj->value',position='$obj->position' where id=$obj->id",'price_timkiem');
}
//
