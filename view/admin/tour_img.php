...
{
    return '<th>id</th><th>danhmuc_id</th><th>highlight</th><th>name</th><th>img</th>';
}
//
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='</select></p>';
    $str_from.='<p><label>highlight</label><input  type="checkbox"  name="highlight" value="1" '.(($form!=false)?(($form->highlight=='1')?'checked':''):'').' /></p>';
