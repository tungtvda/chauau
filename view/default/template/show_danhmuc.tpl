    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ul class="nav nav-tabs package-nav-tab" role="tablist">
                ...
                <li style="{hidden_new}" class="{active_tintuc}"><a href="#itinerary" role="tab" data-toggle="tab" aria-expanded="false">Tin tức</a></li>
            ...
            <div class="tab-content package-tab-content">
                ...
                <!--itinerary-->
                <div  class="tab-pane  {active_tintuc}" id="itinerary" style="bottom: 0px; {hidden_new}">
            ...
            <div class="col-sm-12 row" style="{show_new}">
