...
var mcVc = function (d, c) {
    ...
    function e(f, k, j, e) {
        var g = "&loop=0&autoplay=1&wmode=opaque&color=bbbbbb&" + (new Date).getTime(), c = f.getAttribute("href"), h = c.toLowerCase().indexOf("vimeo.com"), b = '<iframe id="mcVideo' + e + '" src="https://player.vimeo.com/video/' + c.substring(h + 10) + "?api=1&player_id=mcVideo" + e + g + '" webkitAllowFullScreen mozallowfullscreen allowFullScreen';
